...
function useToast() {
    _s();
    const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])({
        "useToast.useSyncExternalStore[state]": (onStoreChange)=>{
            listeners.push(onStoreChange);
            return ({
                "useToast.useSyncExternalStore[state]": ()=>{
        ...
        "useToast.useSyncExternalStore[state]": ()=>memoryState
    }["useToast.useSyncExternalStore[state]"], {
        "useToast.useSyncExternalStore[state]": ()=>memoryState
    }["useToast.useSyncExternalStore[state]"]);
    return {
...
_s(useToast, "k5lLvDpimy+p0C4C3bMaFVMfQ6Y=", false, function() {
    return [
...
const ToastViewport = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = ({ className, ...props }, ref)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Viewport"], {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed bottom-0 z-[100] flex w-full flex-col-reverse items-center p-4 sm:bottom-4", className),
        ...props
    }, void 0, false, {
...
const toastVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("group pointer-events-auto relative flex w-auto max-w-[90vw] items-center justify-between space-x-4 overflow-hidden rounded-2xl border p-4 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=open]:slide-in-from-bottom-full sm:max-w-md", {
    variants: {
        variant: {
            default: "border-white/20 bg-background/80 text-foreground backdrop-blur-sm",
            destructive: "destructive group border-destructive/50 bg-destructive/80 text-destructive-foreground backdrop-blur-sm"
        }
    },
    defaultVariants: {
        variant: "default"
...
const SoundProvider = ({ children })=>{
    ...
    const backgroundAudioRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const playBackgroundMusic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SoundProvider.useCallback[playBackgroundMusic]": ()=>{
            if (isMuted) return;
            if (!backgroundAudioRef.current) {
                try {
            ...
            if (backgroundAudioRef.current.paused) {
                backgroundAudioRef.current.play().catch({
                    "SoundProvider.useCallback[playBackgroundMusic]": (e)=>{
    ...
    const stopBackgroundMusic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SoundProvider.useCallback[stopBackgroundMusic]": ()=>{
    ...
    const toggleMute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SoundProvider.useCallback[toggleMute]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SoundProvider.useEffect": ()=>{
            const handleFirstInteraction = {
                "SoundProvider.useEffect.handleFirstInteraction": ()=>{
    ...
    const playSound = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SoundProvider.useCallback[playSound]": (type)=>{
            if (isMuted) return;
            try {
                const audio = new Audio(SOUND_FILES[type]);
                audio.volume = volume;
                audio.play().catch({
                    "SoundProvider.useCallback[playSound]": (e)=>console.error(`Error playing sound: ${type}`, e)
                }["SoundProvider.useCallback[playSound]"]);
            } catch (error) {
    ...
    return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(SoundContext.Provider, {
        value
    }, children);
};
_s(SoundProvider, "xN9eFtqLg+iFZEzaO5s2u+mpJb4=");
_c = SoundProvider;
const useSound = ()=>{
    _s1();
...
_s1(useSound, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
//# sourceMappingURL=src_b14b5d77._.js.map